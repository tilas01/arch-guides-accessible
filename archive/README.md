...
This directory contains scripts and archived repositories for crucial dependencies used by the *nix Install Guides project. 
...
Please credit the original authors when distributing these archives.
