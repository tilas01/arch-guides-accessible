...
```bash
cargo install --git https://github.com/tilas01/arch-guides-dynamic.git libre-otp
cargo install --git https://github.com/tilas01/arch-guides-dynamic.git scarecrow
```
