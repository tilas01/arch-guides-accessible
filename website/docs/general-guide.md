...
```bash
cargo install --git https://github.com/tilas01/unix-dynamic-guides.git libre-otp
cargo install --git https://github.com/tilas01/unix-dynamic-guides.git scarecrow
```
