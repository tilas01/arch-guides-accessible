...
cd unix-dynamic-guides/security-tools
...
[release page](https://github.com/tilas01/unix-dynamic-guides/releases). If they
...
[opening an issue](https://github.com/tilas01/unix-dynamic-guides/issues).
