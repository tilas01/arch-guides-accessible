...
(function () {
    ...
    function buildManualGuide(s) {
        ...
        L.push('Generated by the [Unix Guides manual walkthrough](https://tilas01.github.io/unix-guides-dynamic/manual.html).');
    ...
    function buildManualScript(s) {
        ...
        L.push('#');
        L.push('# Arch Linux install — generated by the Unix Guides manual walkthrough.');
        L.push('#');
