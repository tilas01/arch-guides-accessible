...
(function () {
    ...
    function buildManualGuide(s) {
        ...
        L.push('Generated by the [Arch Guides manual walkthrough](https://tilas01.github.io/unix-dynamic-guides/manual.html).');
        ...
        L.push('   [Verifier](https://tilas01.github.io/unix-dynamic-guides/iso-verify.html).');
        ...
        if ((s.security_tools || []).length) {
            ...
            L.push('');
            L.push('```bash');
            L.push('curl -fsSL https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/scripts/install-security-suite.sh -o install.sh');
        ...
        L.push('');
        L.push('- [The wiki](https://tilas01.github.io/unix-dynamic-guides/wiki.html) — every option above, explained in full');
        L.push('- [Firmware lockdown](https://tilas01.github.io/unix-dynamic-guides/wiki.html#bios-lockdown) — do this if you have not');
        L.push('- [AUR safety](https://tilas01.github.io/unix-dynamic-guides/wiki.html#aur-safety) — before you install your first AUR package');
