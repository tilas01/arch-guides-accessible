...
(function () {
    ...
    const WIKI = {
        ...
        // Arch Rusty Security Suite sections
        '🦀 Arch Rusty Security Suite':    '?page=security-suite.md',
        'ARSS — Security Tools':           '?page=security-suite.md',
        'OTP Enforcement Mode':            '?page=security-suite.md',
        'OTP Hash Algorithm':              '?page=security-suite.md',
        'Keystroke Anonymisation':         '?page=security-suite.md',
        'Keystroke Anonymisation — kloak': '?page=security-suite.md',
        'Malware Detection Webhooks':      '?page=security-suite.md',
        'Notification Webhooks':           '?page=security-suite.md',
        'Hardened SSH via ARSS + OTP':     '?page=security-suite.md',
        'ARSS Hardened SSH + OTP':         '?page=security-suite.md',
        'Anti-Evil Maid Decoys':           '?page=security-suite.md',
        'Panic Password':                 '?page=security-suite.md',
        'Other Security Tools':            '?page=security-suite.md',
        'Arch ISO Verification':           '?page=security-suite.md',
        // Notification setup
