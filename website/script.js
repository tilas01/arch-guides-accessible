...
// =============================================
// Unix Guides Dynamic - Main Script
...
`;
        ...
        if (cmdOnly) {
            ...
            o += `\`\`\`\n\n---\n*Guide complete. Reboot into your ${desktop !== "none" ? desktop : "TTY"} environment.*\n*Generated by [Unix Guides Dynamic](https://tilas01.github.io/unix-guides-dynamic/) — by [tilas01](https://github.com/tilas01)*\n`;
        }
...
function buildLuksDuress(action, decoyEnv, partRoot, cmdOnly) {
    ...
    o += `# Generated by Unix Guides Dynamic. Contains no passphrase, only a hash.\n`;
    o += `ACTION=${action}\n`;
            ...
            reader.onload = (ev) => {
                try {
                    ...
                    if (data.generator !== "unix-guides-dynamic" &&
                        ...
                        throw new Error(
                            "This is valid JSON, but it is not an Unix Guides config: " +
    ...
    const observer = new IntersectionObserver(entries => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                if (title) document.title = 'Unix Guides | ' + title;
            }
        });
    }, { threshold: 0.5 });
