...
const CONFIG_SCHEMA = 'unix-dynamic-guides/config';
...
`;
        ...
        if (selectedSuite.length > 0) {
            if (!cmdOnly) {
                ...
                o += `> \`\`\`bash\n`;
                o += `> curl -fsSLO https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/scripts/install-security-suite.sh\n`;
            ...
            o += `  https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/scripts/security-alert.sh\n`;
        ...
        if (cmdOnly) {
            ...
            o += `curl -sL "https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/docs/cheatsheets/arch-commands.md" -o /home/$u1/cheatsheets/arch-commands.md\n`;
            if (desktop === 'dusky') {
                o += `curl -sL "https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/docs/cheatsheets/duskyos-hyprland.md" -o /home/$u1/cheatsheets/duskyos-hyprland.md\n`;
            }
            o += `chown -R $u1:$u1 /home/$u1/cheatsheets\n`;
            o += emitWallpapers('/home/$u1/Pictures/wallpapers', '$u1');
        } else {
            o += `\n### 11. Download Cheatsheets\n\`\`\`bash\nmkdir -p ~/cheatsheets\ncurl -sL "https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/docs/cheatsheets/arch-commands.md" -o ~/cheatsheets/arch-commands.md\n`;
            if (desktop === 'dusky') {
                o += `curl -sL "https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/docs/cheatsheets/duskyos-hyprland.md" -o ~/cheatsheets/duskyos-hyprland.md\n`;
            }
            o += `\`\`\`\n`;
        ...
        if (cmdOnly) {
            ...
            o += `\`\`\`\n\n---\n*Guide complete. Reboot into your ${desktop !== "none" ? desktop : "TTY"} environment.*\n*Generated by [Arch Guides Dynamic](https://tilas01.github.io/unix-dynamic-guides/) — by [tilas01](https://github.com/tilas01)*\n`;
        }
        ...
        if (selectedSecApps.length > 0) {
            ...
            o += `#!/bin/bash\nset -e\n`;
            o += `APP=$1\n`;
            o += `REPO="tilas01/unix-dynamic-guides"\n`;
        ...
        scInput.addEventListener('change', (e) => {
            ...
            reader.onload = (ev) => {
                try {
                    ...
                    if (data.generator !== "unix-dynamic-guides" &&
                        data.schema !== "unix-dynamic-guides/config") {
                        throw new Error(
...
function deployOutput() {
    ...
    el.value = `wget -qO- https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/arch-setup.sh | bash`;
