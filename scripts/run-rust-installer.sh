...
curl -sLO https://github.com/tilas01/unix-dynamic-guides/releases/download/latest/arch-installer-linux-x86_64
curl -sLO https://github.com/tilas01/unix-dynamic-guides/releases/download/latest/arch-installer-linux-x86_64.sha256
...
curl -sLO https://github.com/tilas01/unix-dynamic-guides/releases/download/latest/arch-installer-linux-x86_64.sig

echo "[+] Fetching official Public Key..."
curl -sL "https://raw.githubusercontent.com/tilas01/unix-dynamic-guides/main/tilas01-public-key.asc" -o tilas01-public-key.asc
