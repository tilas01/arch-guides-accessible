...
* **Firmware-level attackers.** See [Hardware & Firmware Security](https://tilas01.github.io/arch-guides-dynamic/wiki.html#hardware-security). Everything here runs after the firmware.
