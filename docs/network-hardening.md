...
* **Firmware-level attackers.** See [Hardware & Firmware Security](https://tilas01.github.io/unix-dynamic-guides/wiki.html#hardware-security). Everything here runs after the firmware.
