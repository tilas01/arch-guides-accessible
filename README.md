...
*   **No Automatic Verification**: Most content has **not** been fully reviewed or tested by a human. Verification of functionality is only guaranteed for the specific hardware and environments explicitly documented in the [officialtestlog.txt](./officialtestlog.txt) file.
