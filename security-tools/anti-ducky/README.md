# <img src="img/icon.svg" width="50" height="50" align="center" style="border-radius: 8px;"> anti-ducky

**Arch Rusty Security Suite — Individual Module**

This repository is part of the [Arch Guides Dynamic](https://github.com/tilas01/arch-guides-dynamic) monorepo. It contains the source code for **anti-ducky**.
